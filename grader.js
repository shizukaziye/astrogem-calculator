...
'  #tab-grader.axis-dps{--axis:#e18aaa}' +
...
'  </ul>' +
'  <p><b>Willpower is efficiency, not damage.</b> It <i>reduces</i> the gem’s cost (<code>effective cost = base cost &minus; willpower level</code>), and a cheaper gem of the same damage is strictly better. It enters as a multiplier on the damage, calibrated so a <b>perfect gem of every base cost ties at grade 100</b> (a perfect 8 / 9 / 10 with willpower 5 sits at effective cost 3 / 4 / 5, and the multiplier makes those three equal). Low willpower is punished hard.</p>' +
...
'  <p class="note">Pulling a character fetches the loadout from lostark.bible (cached 7 days; &ldquo;Re-pull&rdquo; forces fresh). Effect ids and each gem’s cost/type are decoded from the page’s grid data &mdash; eyeball a gem or two against the in-game display.</p>' +
'</details>';
  }
